...
class HomeEndDrawer extends ConsumerWidget {
  ...
  static const _lifeItems = [
    ...
    _DrawerItem('✝️', 'Évangile', _DrawerAction.gospel),
    _DrawerItem('📚', 'Bible', _DrawerAction.bible),
    _DrawerItem('🙏', 'Prières', _DrawerAction.prayers),
    _DrawerItem('📿', 'Chapelets', _DrawerAction.chaplets),
    _DrawerItem('👼', 'Saints', _DrawerAction.saints),
    _DrawerItem('❤️', 'Intentions', _DrawerAction.intentions),
  ...
  void _openItem(BuildContext context, _DrawerItem item) {
    switch (item.action) {
      case _DrawerAction.liturgy:
        _open(context, const LiturgyTodayScreen());
      case _DrawerAction.gospel:
        _open(context, const GospelScreen());
      case _DrawerAction.bible:
        _open(context, const BibleHomeScreen());
      case _DrawerAction.prayers:
        _open(context, const PrayersScreen(title: 'Prières', categories: ['priere', 'neuvaine', 'litanie']));
      case _DrawerAction.chaplets:
        _open(context, const PrayersScreen(title: 'Chapelets', categories: ['chapelet']));
      case _DrawerAction.saints:
        _open(context, const SaintsScreen());
      case _DrawerAction.intentions:
        _open(context, const IntentionsScreen());
...
enum _DrawerAction { liturgy, gospel, bible, prayers, chaplets, saints, intentions, soon }
